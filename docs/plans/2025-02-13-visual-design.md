...
| Body | **PT Serif** | 400, 700 | Основной текст, описания, записки *(заменён Crimson Pro — не поддерживает кириллицу)* |
| Handwritten | **Caveat** | 500, 700 | Подписи настроений, подписи фото, "от кого" на записках |
| UI | **Alegreya Sans** | 400, 500, 700 | Кнопки, навигация, метки форм, мелкий текст *(вес 600 не существует, используем 700)* |
...
fontFamily: {
  ...
  body:    ['"PT Serif"', 'Georgia', 'serif'],  // Заменён Crimson Pro (нет кириллицы)
  hand:    ['"Caveat"', 'cursive'],
